...
| S8 | TIBCO BW5 Conversion | **✅ DONE** | ProcessDef → iFlow; services/iflow-generator-tibco-bw5.js + engine/iflow-tibco-bw5-bpmn.js + route wiring; fixed BW6 platform check |
| S9 | Boomi Enhancement | **NEXT** | Boomi raw_xml + real iFlow generation |
...
**Current sprint to start next**: S9 — Boomi Enhancement
